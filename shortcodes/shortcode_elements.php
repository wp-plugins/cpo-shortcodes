...
if(!function_exists('ctsc_shortcode_team')){
	function ctsc_shortcode_team($atts, $content = null){
		...
		if($web != '') $output .= "<a class='primary-color ctsc-primary-color-border' href='$web'><span class='icon-link'></span></a>";
		if($facebook != '') $output .= "<a class='primary-color ctsc-primary-color-border' href='$facebook'><span class='icon-facebook'></span></a>";
		if($twitter != '') $output .= "<a class='primary-color ctsc-primary-color-border' href='$twitter'><span class='icon-twitter'></span></a>";
		if($gplus != '') $output .= "<a class='primary-color ctsc-primary-color-border' href='$gplus'><span class='icon-google-plus'></span></a>";
		if($linkedin != '') $output .= "<a class='primary-color ctsc-primary-color-border' href='$linkedin'><span class='icon-linkedin'></span></a>";
		if($pinterest != '') $output .= "<a class='primary-color ctsc-primary-color-border' href='$pinterest'><span class='icon-pinterest'></span></a>";
		if($tumblr != '') $output .= "<a class='primary-color ctsc-primary-color-border' href='$tumblr'><span class='icon-tumblr'></span></a>";
		$output .= '</div>';
		$output .= '</div>';
		$output .= '</div>';
